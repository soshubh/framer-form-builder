...
export const DEFAULT_CONFIG: BuilderConfig = {
  ...
  styling: {
    ...
    fieldGap: 14,
    primaryColor: "#FF4C00",
    surfaceColor: "rgba(250, 250, 250, 0.92)",
    borderColor: "#EDEDED",
    textColor: "#121212",
    labelColor: "#404040",
    placeholderColor: "#727272",
    sectionSurfaceColor: "rgba(250, 250, 250, 0.98)",
    sectionBorderColor: "#EDEDED",
    sectionTitleColor: "#121212",
    sectionBodyColor: "#404040",
    sectionBorderWidth: 1,
    fieldSurfaceColor: "rgba(250, 250, 250, 0.98)",
    fieldBorderColor: "#EDEDED",
    fieldTextColor: "#121212",
    fieldLabelColor: "#404040",
    fieldHelperColor: "#404040",
    fieldPlaceholderColor: "#727272",
    fieldFocusColor: "#FF4C00",
    fieldBorderWidth: 1,
    fieldFocusWidth: 1,
    buttonBorderColor: "#FF4C00",
